 ...
 */
class Paraassood_Swatchswitcher_Helper_Image extends Mage_Catalog_Helper_Image
{
    ...
    {
        $product = $this->_getSwatchProduct($product);
     ...
     * @return mixed
     */
    protected function _getSwatchProduct($product)
    {
